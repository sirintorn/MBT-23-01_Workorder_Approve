...
import '../screens/work_order_report_screen.dart';
    ...
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Container(
          ...
          // This should be larger than the screen width
        ...
        child: Column(
          ...
          children: [
            ...
            TextButton(onPressed: () {
              // Navigate to the work order report with dynamic ID
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => WorkOrderReportScreen(
                    workOrderId: widget.item.codeCoil, // Using the dynamic codeCoil
                  ),
                ),
              );
