...
class Error_Screen_1 extends StatefulWidget {
  const Error_Screen_1({super.key});

  @override
  State<Error_Screen_1> createState() => _Error_Screen_1State();
}

class _Error_Screen_1State extends State<Error_Screen_1> {
  ...
  Widget centercontain(){
    return  Padding(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          Image(image: const AssetImage('assets/Iconerror.png'),color: notifire.textcolore,),
          const SizedBox(height: 10,),
          Text('404-Page not found',style: TextStyle(fontSize: 30,color: notifire.textcolore),),
          const SizedBox(height: 10,),
