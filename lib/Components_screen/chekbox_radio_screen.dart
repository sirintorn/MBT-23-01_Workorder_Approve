                              ...
                              children: [
                                ...
                                InkWell(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text('Check this Custom checkbox',
                                          style: TextStyle(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Flexible(
                                    ...
                                    padding: const EdgeInsets.only(
                                        left: 15, right: 15),
                                    child: Text('Toggle this Custom radio',
                                        overflow: TextOverflow.ellipsis,
                                        style: TextStyle(
                                            color: notifire.textcolore)),
                                  )),
...
//   }
            ...
            child: Center(
              child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: select1 ? Colors.red : notifire.textcolore,
                          width: 2)),
                  // ignore: unrelated_type_equality_checks
                  child: select1
                      ? const Icon(Icons.circle, size: 13, color: Colors.red)
                      : const SizedBox()),
            ),
          ),
        ),
          ...
          child: InkWell(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    // ignore: unrelated_type_equality_checks
                    border: Border.all(
                        color: select2 ? Colors.blue : notifire.textcolore,
                        width: 2)),
                // ignore: unrelated_type_equality_checks
                child: select2
                    ? const Icon(Icons.circle, size: 13, color: Colors.blue)
                    : const SizedBox()),
          ),
        ),
        InkWell(
          ...
          child: InkWell(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    // ignore: unrelated_type_equality_checks
                    border: Border.all(
                        color: select3 ? Colors.green : notifire.textcolore,
                        width: 2)),
                // ignore: unrelated_type_equality_checks
                child: select3
                    ? const Icon(Icons.circle, size: 13, color: Colors.green)
                    : const SizedBox()),
          ),
        ),
        InkWell(
          ...
          child: InkWell(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    // ignore: unrelated_type_equality_checks
                    border: Border.all(
                        color: select4 ? Colors.pink : notifire.textcolore,
                        width: 2)),
                // ignore: unrelated_type_equality_checks
                child: select4
                    ? const Icon(Icons.circle, size: 13, color: Colors.pink)
                    : const SizedBox()),
          ),
        ),
        InkWell(
          ...
          child: InkWell(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color:
                            select6 ? Colors.deepOrange : notifire.textcolore,
                        width: 2)),
                // ignore: unrelated_type_equality_checks
                child: select6
                    ? const Icon(Icons.circle,
          ...
          child: InkWell(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    // ignore: unrelated_type_equality_checks
                    border: Border.all(
                        color: select7 ? Colors.amber : notifire.textcolore,
                        width: 2)),
                // ignore: unrelated_type_equality_checks
                child: select7
                    ? const Icon(Icons.circle, size: 13, color: Colors.amber)
                    : const SizedBox()),
          ),
        ),
        InkWell(
          ...
          child: InkWell(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color:
                            select8 ? Colors.deepPurple : notifire.textcolore,
                        width: 2)),
                // ignore: unrelated_type_equality_checks
                child: select8
                    ? const Icon(Icons.circle,
          ...
          child: InkWell(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color:
                            select9 ? Colors.greenAccent : notifire.textcolore,
                        width: 2)),
                // ignore: unrelated_type_equality_checks
                child: select9
                    ? const Icon(Icons.circle,
  ...
  Widget radio1() {
    return Radio(
        fillColor: MaterialStatePropertyAll<Color>(notifire.textcolore),
        value: "radio value",
        groupValue: result1,
        onChanged: (value) {
          setState(() {
          ...
          child: InkWell(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    // ignore: unrelated_type_equality_checks
                    border: Border.all(
                        color: other ? Colors.blue : notifire.textcolore,
                        width: 2)),
                // ignore: unrelated_type_equality_checks
                child: other
                    ? const Icon(Icons.circle, size: 13, color: Colors.blue)
          ...
          child: InkWell(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    // ignore: unrelated_type_equality_checks
                    border: Border.all(
                        color: ext ? Colors.blue : notifire.textcolore,
                        width: 2)),
                // ignore: unrelated_type_equality_checks
                child: ext
                    ? const Icon(Icons.circle, size: 13, color: Colors.red)
  ...
  Widget radio2() {
    return Radio(
      fillColor: MaterialStateProperty.all<Color?>(notifire.textcolore),
      value: "radio value",
      groupValue: result2,
      onChanged: (value) {
        setState(() {
                ...
                child: SizedBox(
                  ...
                  child: Row(
                    children: [
                      ...
                      Image(
                          image:
                              const AssetImage('assets/registered-circle.png'),
                          color: notifire.textcolore),
                      // SizedBox(width: 10,),
